...
DEFAULT_CONFIG = {"llm": {"provider": "local", "local_enabled": True, "local_base_url": "http://127.0.0.1:11434/v1", "local_model": "qwen3:0.6b", "api_enabled": False, "api_base_url": "https://api.deepseek.com", "api_model": "deepseek-chat"}, "resources": {"files": {"enabled": True, "root": "."}, "web_search": {"enabled": False}, "email": {"enabled": False}, "crm": {"enabled": False}, "website": {"enabled": False}}}
